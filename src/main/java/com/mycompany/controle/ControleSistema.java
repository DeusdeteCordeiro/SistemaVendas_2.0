...
public class ControleSistema {
    ...
    public static void alterar(int indiceProduto) {
        ...
        if(object instanceof VideoGame){
            ...
            videoGame = (VideoGame) VisaoMenu.menuAltercaoProdutoInformacoes(videoGame);
            ...
            System.out.println("|Alterndo o produto" + computador.toString());
            
            computador = (Computador) VisaoMenu.menuAltercaoProdutoInformacoes(computador);
